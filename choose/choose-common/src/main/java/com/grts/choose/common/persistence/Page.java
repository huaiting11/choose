package com.grts.choose.common.persistence;
...
import com.grts.choose.common.config.Global;
import com.grts.choose.common.utils.CookieUtils;
...
public class Page<T> {
    ...
    private int pageSize = 12;//Integer.valueOf(Global.getConfig("page.pageSize")); // 页面大小，设置为“-1”表示不进行分页（分页无效）
            ...
            if(pageNo >= 6) {
                ...
                if(last >= pageNo + 5) {
                    for(int i = pageNo-2; i <= pageNo + 2; i++) {
                        if(pageNo == i) {
                            sb.append("<span class='activePage'>"+ i +"</span>");
                        }else {
                            sb.append("<span>"+ i +"</span>");
                        }
                    }
                    sb.append("<span>...</span>");
                    sb.append("<span>"+ (last - 1) +"</span>");
                ...
                if(last > 8) {
                    ...
                    sb.append("<span>7</span>");
                    sb.append("<span>8</span>");
                    sb.append("<span></span>");
                }else{
                    sb.append("<span>7</span>");
                    sb.append("<span></span>");
